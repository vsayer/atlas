...
var TypeRegistry = specutil.NewRegistry(
	...
	specutil.WithSpecs(
		...
		specutil.AliasTypeSpec("time_with_time_zone", TypeTimeWTZ, &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}),
		specutil.AliasTypeSpec("time_without_time_zone", TypeTimeWOTZ, &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}),
		specutil.TypeSpec(TypeTimestampTZ, &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}),
		specutil.TypeSpec(TypeTimestamp, &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}),
		specutil.AliasTypeSpec("timestamp_with_time_zone", TypeTimestampWTZ, &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}),
		specutil.AliasTypeSpec("timestamp_without_time_zone", TypeTimestampWOTZ, &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}),
